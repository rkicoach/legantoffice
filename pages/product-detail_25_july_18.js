			...
			if (data.readResponseList.readResponse[0].record) {
				...
				$.each(custofield, function (key, value) {
					...
					if (value.$attributes.scriptId == 'custitem_pers_preview_url') {
					        ...
					        custitem_pers_preview_url = custitem_pers_preview_url.replace('https://storage.googleapis.com/next-teo.appspot.com/static/personalization/preview','https://teo-personalization.imgix.net')
					}
	...
	render() {
		...
		return (
			<div className='wrapper'>
				...
				data={{ custitem_deboss_example_url, custitem_uv_example_url, custitem_logo_lead_time, custitem_logo_line_url, custitem_deboss_color_options, custitem_monogram_style_options, custitem_pers_lead_time, custitem_monogram_color_options, custitem_pers_line_url, custitem_pers_preview_url }}
