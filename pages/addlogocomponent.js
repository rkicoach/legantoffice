...
<App
  ...
  >
  <Heading bold is="h1" mt={2} mb3>Add A Logo</Heading>
      < Addlogo />
  </App>
);

Addlogocomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Addlogocomponent.displayName = 'Addlogocomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Addlogocomponent);
