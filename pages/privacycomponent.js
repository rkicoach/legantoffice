...
Privacycomponent.getInitialProps = async ({ store, isServer, query }) => {
  ...
  const pageData = { name: 'Privacy Policy & Legal Info' };
...
Privacycomponent.displayName = 'Privacycomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Privacycomponent);
