...
Diningcomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Diningcomponent.displayName = 'Diningcomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Diningcomponent);
