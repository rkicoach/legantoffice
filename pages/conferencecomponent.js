...
Conferencecomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Conferencecomponent.displayName = 'Conferencecomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Conferencecomponent);
