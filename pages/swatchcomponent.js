...
Swatchcomponent.getInitialProps = async ({ store, isServer, query }) => {
  ...
  const pageData = { name: 'Returns' };

  return { pageData, slug };
};

Swatchcomponent.propTypes = {
...
Swatchcomponent.displayName = 'Swatchcomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Swatchcomponent);
