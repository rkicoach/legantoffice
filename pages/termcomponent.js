...
Termcomponent.getInitialProps = async ({ store, isServer, query }) => {
  ...
  const pageData = { name: 'Terms & Conditions' };
...
Termcomponent.displayName = 'Termcomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Termcomponent);
