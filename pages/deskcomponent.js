...
Deskcomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Deskcomponent.displayName = 'Deskcomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Deskcomponent);
