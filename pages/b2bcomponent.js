...
B2bcomponent.getInitialProps = async ({ store, isServer, query }) => {
...
B2bcomponent.displayName = 'B2bcomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(B2bcomponent);
