...
Returncomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Returncomponent.displayName = 'Returncomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Returncomponent);
