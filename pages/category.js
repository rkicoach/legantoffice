...
class Category extends React.Component {
  ...
  >
    ...
    <Results
      isLarge={isLarge}
      promoTopper={props.pageData.promoTopper}
      imageUrl={props.pageData.imageUrl}
...
Category.getInitialProps = async ({ store, isServer, query }) => {
  ...
  if(query['search']) {
	      pageData.name = query['search']
	      pageData.metaTitle = query['search']
	    }
  return { pageData:pageData, category, subcategory, tabs, activeTab };
};
