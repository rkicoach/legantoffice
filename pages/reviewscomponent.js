...
Reviewscomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Reviewscomponent.displayName = 'Reviewscomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Reviewscomponent);
