...
import TablePad from './table-pad';

const Tablepadcomponent = props => (
...
Tablepadcomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Tablepadcomponent.displayName = 'Tablepadcomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Tablepadcomponent);
