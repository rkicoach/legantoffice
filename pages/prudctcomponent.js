...
import ProductCard from '../components/instantsearch/product-card';
import ProductGrid from '../components/instantsearch/product-grid';


const Prudctcomponent = props => (
  ...
  >
    ...
    <Heading bold is="h1" my={2}>
      {props.pageData.name}{props.slug}
      < ProductTable />
    </Heading>
...
Prudctcomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Prudctcomponent.displayName = 'Prudctcomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Prudctcomponent);
