...
Contactcomponent.getInitialProps = async ({ store, isServer, query }) => {
...
}), { openMenu, showModal, hideModal, setLoadingState })(Contactcomponent);
