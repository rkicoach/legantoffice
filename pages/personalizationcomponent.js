...
const Personalizationcomponent = props => (
...
Personalizationcomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Personalizationcomponent.propTypes = {
...
Personalizationcomponent.displayName = 'Personalizationcomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Personalizationcomponent);
