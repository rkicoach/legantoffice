...
export default () => (
  <Box mb4 className='mobilePadding'>
	...
	<Text>Full Color Printing - Replicate your logo in its full color.  This printing process allows us to capture an unlimited number of colors and color gradients.  The ink is flush with the surface of the item.</Text>
    <Heading is='h2' bold mb2 mt2>The Process</Heading>
    ...
    <Text>Whether you need additional products or another location is outfitting their facility, once the die or logo file is created, it may be used repeatedly over the next five (5) years.  A reorder setup will be incurred;</Text>
        <Box is='ul' pl0 css={style.list}>
           <li>Deboss or Foil Stamp - $25 per order
	</li>
      <li>Full Color Print - $40 per order
	</li>
    </Box>
  </Box>
)
