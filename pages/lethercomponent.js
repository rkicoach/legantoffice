...
import LetherType from './lether-type';

const Lethercomponent = props => (
...
Lethercomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Lethercomponent.displayName = 'Lethercomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Lethercomponent);
