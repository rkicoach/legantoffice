...
import WhyConferencePads from './whyconferencepads';

const Whyconferencecomponent = props => (
...
Whyconferencecomponent.getInitialProps = async ({ store, isServer, query }) => {
...
Whyconferencecomponent.propTypes = {
...
Whyconferencecomponent.displayName = 'Whyconferencecomponent';
...
}), { openMenu, showModal, hideModal, setLoadingState })(Whyconferencecomponent);
