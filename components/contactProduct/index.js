...
class ContactProduct extends React.Component {
    constructor(props) {
	 ...
	 _handleSubmit(e) {
		...
		alert("Message has been sent successfully!");
		this.props.hide('custom_products')
	 	}
	 	return false;
	 }
    ...
    render() {
        ...
        return (
            <Modal show={this.props.open} onHide={e=>this.props.hide('custom_products')} className="custom-modal">
				<Modal.Header closeButton>
					<Modal.Title>Custom Products</Modal.Title>
				</Modal.Header>
				<Modal.Body>
					<form>
						<div className="row">
							<div className="col-sm-6">
								<div className="form-group">
									...
									<input name="formname" ref="formname" type="hidden" className="form-control" value="custom product"/>
						...
						<div className="form-group">
							{/*<label>The Elegant Office, Inc.</label>
							<label>5200 NW 43rd Street, Suite 102-256</label>
							<label>Gainesville, FL 32606 USA</label>
							<a href="#">866-433-7573</a>
							<a>sales@TheElegantOffice.com</a>*/}
							Helpful details include: product type, dimensions, material, color, and quantity.
						</div>
